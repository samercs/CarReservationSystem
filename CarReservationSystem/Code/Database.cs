...
using System.IO;
using CarReservationSystem.Code.Enum;
using MySql.Data.MySqlClient;
using ConnectionState = CarReservationSystem.Code.Enum.ConnectionState;
...
namespace CarReservationSystem.Code
{
    public class Database : IDisposable
    {
        ...
        public Database(Providers provider)
            : this(ConfigurationManager.ConnectionStrings["DefaultConnectionString"].ConnectionString, provider)
        {
        }

        public Database(string connectionstring)
            : this(connectionstring, Providers.MySql)
        {
        }

        public Database()
            : this(ConfigurationManager.ConnectionStrings["DefaultConnectionString"].ConnectionString, Providers.MySql)
        {
        }
